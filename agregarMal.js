...
function agregarAmigo(){
    let amigo = document.querySelector('#amigo').value.trim();// Obtengo el valor del input y lo almaceno en campoAmigxs
    if (!amigo || amigo === '') {// le digo a la funcion que si el campo esta vacio y no se ingreso ningun nombre,se muestre un alert
